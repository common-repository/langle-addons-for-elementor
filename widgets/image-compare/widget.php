...
class Image_Compare extends Base {
    ...
    public function get_title() {
        return __( 'Image Compare', 'langle-addons' );
    }
    ...
    protected function __image_content_controls() {
        ...
        $this->add_control(
            'before_label',
            [
                'label' => __( 'Label', 'langle-addons' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Before', 'langle-addons' ),
                'placeholder' => __( 'Type before image label', 'langle-addons' ),
                'description' => __( 'Label will not be shown if Hide Overlay is enabled in Settings', 'langle-addons' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Label', 'langle-addons' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'After', 'langle-addons' ),
                'placeholder' => __( 'Type after image label', 'langle-addons' ),
                'description' => __( 'Label will not be shown if Hide Overlay is enabled in Settings', 'langle-addons' ),
                'dynamic' => [
                    'active' => true,
                ]
    ...
    protected function __settings_content_controls() {
        ...
        $this->add_control(
            'offset',
            [
                'label' => __( 'Visibility Ratio', 'langle-addons' ),
        ...
        $this->add_control(
            'orientation',
            [
                'label' => __( 'Orientation', 'langle-addons' ),
        ...
        $this->add_control(
            'hide_overlay',
            [
                'label' => __( 'Hide Overlay', 'langle-addons' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Yes', 'langle-addons' ),
                'label_off' => __( 'No', 'langle-addons' ),
                'return_value' => 'yes',
                'description' => __( 'Hide overlay with before and after label', 'langle-addons' ),
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            'move_handle',
            [
                'label' => __( 'Move Handle', 'langle-addons' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'on_swipe',
                'options' => [
                    'on_hover' => __( 'On Hover', 'langle-addons' ),
                    'on_click' => __( 'On Click', 'langle-addons' ),
                    'on_swipe' => __( 'On Swipe', 'langle-addons' ),
                ],
                'description' => __( 'Select handle movement type. Note: overlay does not work with On Hover.', 'langle-addons' ),
                'style_transfer' => true,
            ]
        );
    ...
    protected function __handle_style_controls() {
        ...
        $this->add_control(
            '_heading_bar',
            [
                'label' => __( 'Handle Bar', 'langle-addons' ),
        ...
        $this->add_control(
            '_heading_arrow',
            [
                'label' => __( 'Handle Arrow', 'langle-addons' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            'arrow_box_width',
            [
                'label' => __( 'Box Width', 'langle-addons' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'arrow_box_height',
            [
                'label' => __( 'Box Height', 'langle-addons' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
    ...
    protected function __label_style_controls() {
        ...
        $this->add_responsive_control(
            'label_offset_y',
            [
                'label' => __( 'Vertical', 'langle-addons' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'label_offset_x',
            [
                'label' => __( 'Horizontal', 'langle-addons' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
    ...
    protected static function get_data_settings( $settings ) {
        ...
        return la_prepare_data_prop_settings( $settings, $field_map );
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'container', 'class', [
            ...
            'sejs-image-comparison',
        ] );

        $this->add_render_attribute( 'container', 'data-langle-settings', self::get_data_settings( $settings ) );
        ?>
    ...
    public function content_template() {
        ...
        view.addRenderAttribute('container', 'data-langle-settings', JSON.stringify(data)); #>

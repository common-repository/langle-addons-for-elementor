...
abstract class Base extends Widget_Base {
     ...
     */
    public function get_name( $ver = false ) {
        /**
    ...
    protected function register_controls() {
        do_action( 'langle_addons_start_register_controls', $this );

        $this->register_content_controls();

        $this->register_style_controls();

        do_action( 'langle_addons_end_register_controls', $this );
	}
    ...
    protected function render_edit_tools() {
        if ( langle_addons_is_elementor_version( '<=', '2.5.16' ) ) {
    ...
    protected function add_inline_editing_attributes( $key, $toolbar = 'basic', $setting_key = '' ) {
        if ( ! la_elementor()->editor->is_edit_mode() ) {
            return;
        }
    ...
    public function add_link_attributes( $element, array $url_control, $overwrite = false ) {
         ...
         */
        if ( langle_addons_is_elementor_version( '>=', '2.8.0' ) ) {
